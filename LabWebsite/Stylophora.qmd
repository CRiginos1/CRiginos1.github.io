...
all <- read_xlsx("~/CRiginos1.github.io/LabWebsite/supporting_docs/Spis_interactive_plot_quarto.xlsx")
...
d3 <- htmltools::htmlDependency(
  "d3", "7.3.0",
  src = c(file= "~/CRiginos1.github.io/LabWebsite/supporting_docs"),  # Specify the source URL for D3 library

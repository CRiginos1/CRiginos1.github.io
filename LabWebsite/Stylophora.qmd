...
all <- read_xlsx("~/Documents/RA_EcoRRAP/CRiginos1.github.io/LabWebsite/supporting_docs/Spis_interactive_plot_quarto.xlsx")
...
d3 <- htmltools::htmlDependency(
  "d3", "7.3.0",
  src = c(file= "~/Documents/RA_EcoRRAP/CRiginos1.github.io/LabWebsite/supporting_docs"),  # Specify the source URL for D3 library
...
js <- 'function(el) {
  ...
  el.on("plotly_hover", function(d) {
    ...
    var xPixel = 15; // Change this to 15
    var yPixel = 6;  // Change this to 6

    // Create an image tag with a custom data source and width
    var img = "<img src=\\\"" +  pt.customdata + "\\\" width=250>";
    tooltip.html(img)
...
uris <- purrr::map_chr(
  all$New_sample_name, ~base64enc::dataURI(file = sprintf("~/Documents/RA_EcoRRAP/CRiginos1.github.io/LabWebsite/supporting_docs/Spis_images/%s.JPG", .x))
)
